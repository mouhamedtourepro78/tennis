...
/**
 * REST controller for managing {@link com.tennis.app.domain.Player}.
 */
@RestController
@RequestMapping("/api")
public class PlayerResource {
    ...
    public ResponseEntity<List<Player>> getAllPlayers(
        ...
        if ("avgstats-is-null".equals(filter)) {
            log.debug("REST request to get all Players where avgStats is null");
            return new ResponseEntity<>(playerService.findAllWhereAvgStatsIsNull(), HttpStatus.OK);
        }
