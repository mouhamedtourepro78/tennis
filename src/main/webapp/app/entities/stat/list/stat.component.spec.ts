...
describe('Stat Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'stat', component: StatComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.stats?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
